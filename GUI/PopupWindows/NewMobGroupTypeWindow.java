...
public class NewMobGroupTypeWindow extends JDialog
{
	JPanel contentPanel;
	public NewMobGroupTypeWindow(GroupTypesListGUI groupTypesListGUI)
	{
		setTheming("Create new Group Category");
		...
		LabeledInputBox type = new LabeledInputBox("Group Code", code);
        ...
        {
        	groupTypesListGUI.newGroupCategory(Utils.strToInt(code.getText()));
        	dispose();
        });
