...
public class RandomMailManager 
{
	...
	private byte[] getEnemyNames(int diff)
	{
		...
		for(int i = 0; i < enemies.size(); i++)
		{
			ret = bFM.Utils.mergeArrays(ret, bFM.Utils.mergeArrays(Utils.encodeStringToBytes(enemies.get(i).getName()),new byte[1]));
		}
		return ret;
	}
	...
	private void writeGroupString(String path) throws IOException
	{
		...
		Files.write(Paths.get(path + "EnemyTeams1.txt"), Utils.encodeStringToBytes(getEnemyString(1)));
		Files.write(Paths.get(path + "EnemyTeams2.txt"), Utils.encodeStringToBytes(getEnemyString(2)));
		Files.write(Paths.get(path + "EnemyTeams3.txt"), Utils.encodeStringToBytes(getEnemyString(3)));
		Files.write(Paths.get(path + "EnemyTeams4.txt"), Utils.encodeStringToBytes(getEnemyString(4)));
		Files.write(Paths.get(path + "EnemyTeams5.txt"), Utils.encodeStringToBytes(getEnemyString(5)));
	}
	private void writePlaceString(String path) throws IOException
	{
		...
		Files.write(Paths.get(path + "RandomLocations1.txt"), Utils.encodeStringToBytes(getLocationString(1)));
		Files.write(Paths.get(path + "RandomLocations2.txt"), Utils.encodeStringToBytes(getLocationString(2)));
		Files.write(Paths.get(path + "RandomLocations3.txt"), Utils.encodeStringToBytes(getLocationString(3)));
		Files.write(Paths.get(path + "RandomLocations4.txt"), Utils.encodeStringToBytes(getLocationString(4)));
		Files.write(Paths.get(path + "RandomLocations5.txt"), Utils.encodeStringToBytes(getLocationString(5)));	
	}
