...
public class ModelVector2Data implements Data
{
	//Byte Vars
	int size;
	Pointer mdl0Pos;
	...
	//Real Vars
	ByteBuffer data;
	ArrayList<VEC2> Verticies = new ArrayList<VEC2>();
	protected ModelVector2Data(ByteBuffer data, Pointer vertexPos, Pointer mdl0Pos)
	{
		//Read Byte Vars
		...
		{
			Verticies.add(new VEC2(data, new Pointer(vertexArrayPos, i * vertexSize)));
		}
	}
