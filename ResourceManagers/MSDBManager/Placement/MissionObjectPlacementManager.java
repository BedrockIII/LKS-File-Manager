...
public class MissionObjectPlacementManager 
{
	...
	public MissionObjectPlacementManager(ArrayList<MobConstantPlace> placeData, ArrayList<MobGroup> GroupData, ArrayList<MobObject> ObjectData)
	{
		Places = placeData;
		Groups = GroupData;
		Objects = ObjectData;
